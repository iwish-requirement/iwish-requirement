...
const releases: ReleaseNote[] = [
  {
    date: "2026-08-25",
    title: "统计准确性与创意部数据底层约束修复",
    summary:
      "统计改为全量稳定分页，并从接口和数据库两层保证需求类型完整、正确归属当前部门。",
    audience: ["创意部", "管理者", "部门负责人", "数据分析"],
    items: [
      {
        title: "统计不再被默认行数截断",
        description:
          "总览、成员、趋势、排行和动态字段统计全部按内部 ID 稳定分页读取，不再受 1000 条或 5000 条上限影响。",
        impact: "历史数据继续增长后，页面统计仍会覆盖满足条件的全部需求。",
        icon: LineChart,
      },
      {
        title: "需求类型建立数据库级约束",
        description:
          "需求类型必须存在且属于需求所在部门，新建、导入、复制和数据库写入均执行同一规则。",
        impact: "空需求类型或跨部门类型无法再进入线上数据，素材与视频分类更可靠。",
        icon: ShieldCheck,
      },
      {
        title: "排期月份作用更明确",
        description:
          "创意部成员工作量按内部排期开始日期归月；缺少排期的历史需求回退到提交月份，并展示回退数量。",
        impact: "排期只决定成员工作量月份，不会改变总览的提交月份、完成月份或实际截止日期。",
        icon: ClipboardList,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        title: "筛选条件自动保留",
        description:
          "关系视图、部门、状态、优先级、人员、日期、需求类型和动态字段筛选会保存在当前浏览器中。",
        impact: "离开需求列表再返回或刷新页面后，仍会恢复上次使用的筛选状态。",
        icon: Filter,
      },
      {
        title: "未完成需求优先展示",
        description:
          "需求列表默认把尚未完成的记录排在已完成记录之前，每组内部继续按最新创建时间排序。",
        impact: "未开始、已排期和处理中等待办需求更容易被发现，不会被大量新近完成记录淹没。",
        icon: ClipboardList,
      },
      {
        title: "恢复页面数量统计",
        description:
          "创意部成员统计重新展示页面数量，同时保留统一的需求数、完成数、素材数量和视频数量字段。",
        impact: "UI 相关工作量不会因统一创意部统计口径而从数据统计页面消失。",
        icon: LineChart,
      },
    ],
  },
